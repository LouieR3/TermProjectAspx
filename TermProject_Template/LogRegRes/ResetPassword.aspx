        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-45">
                <div class="login100-form validate-form flex-sb flex-w">
                    <span class="login100-form-title p-b-32">Reset Password
                    </span>

                    <span class="txt1 p-b-11">New Password
                    </span>
                    <div class="wrap-input100 validate-input m-b-36" data-validate="Email is required">
                        <asp:TextBox ID="txtPass" class="input100" name="password" runat="server"></asp:TextBox>
                    ...
                    <div class="wrap-input100 validate-input m-b-36" data-validate="Email is required">
                        <asp:TextBox ID="txtConfirm" class="input100" name="confirm" runat="server"></asp:TextBox>
                        <span class="focus-input100"></span>
                    </div>
