...
<asp:Content ID="Content3" ContentPlaceHolderID="Content1" runat="server">
    <div class="container-login101">
        <div class="wrap-login10 p-l-85 p-r-85 p-t-55 p-b-45">
            ...
            <asp:GridView ID="gvTransactions" runat="server" class="gv1" ForeColor="Black" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
