...
<asp:Content ID="Content3" ContentPlaceHolderID="Content1" runat="server">
    ...
    <asp:GridView ID="gvAddOn" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gvEmails_PageIndexChanging" PageSize="5" style="z-index: 1; left: 92px; top: 336px; position: absolute; height: 217px; width: 157px" Visible="False">
        <Columns>
    ...
    <asp:Button ID="btnUpload" runat="server" style="z-index: 1; left: 432px; top: 205px; position: absolute" Text="Upload" OnClick="btnUpload_Click" />
    <asp:Label ID="lblStatus" runat="server" style="z-index: 1; left: 400px; top: 140px; position: absolute"></asp:Label>
    ...
    <asp:Button ID="btnDeleteAddOn" runat="server" style="z-index: 1; left: 297px; top: 345px; position: absolute" Text="Delete Add On" OnClick="btnDeleteAddOn_Click" />
</asp:Content>
