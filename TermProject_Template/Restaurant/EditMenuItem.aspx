...
<asp:Content ID="Content3" ContentPlaceHolderID="Content1" runat="server">
    ...
    <asp:Label ID="lblAddOns" runat="server" Text="Item Add On's:" style="z-index: 1; left: 96px; top: 299px; position: absolute; right: 416px;" ForeColor="Black"></asp:Label>
    
    <asp:Button ID="btnNewAddOn" runat="server" style="z-index: 1; left: 294px; top: 307px; position: absolute" Text="New Add On" OnClick="btnNewAddOn_Click" Enabled="False" />
    ...
    <asp:GridView ID="gvAddOn" runat="server" AutoGenerateColumns="False" style="z-index: 1; left: 92px; top: 336px; position: absolute; height: 217px; width: 157px">
        <Columns>
    ...
    <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 387px; top: 52px; position: absolute" Text="Edit" OnClick="btnEdit_Click" />
    ...
    <asp:Button ID="btnDeleteAddOn" runat="server" style="z-index: 1; left: 297px; top: 345px; position: absolute" Text="Delete Add On" OnClick="btnDeleteAddOn_Click" Enabled="False" />
    <asp:Label ID="lblStatus" runat="server" style="z-index: 1; left: 394px; top: 123px; position: absolute" Text="Label" ForeColor="Black" Visible="False"></asp:Label>
